...
{
    public partial class FormPediatria : Form
    {
        public FormPediatria()
        {
            InitializeComponent();
            MostrarConsultorio();
        }
        public void MostrarConsultorio()
        {
            ...
            lblConsultorio.Text = "PED" + random.Next(1, 5).ToString("000#");
        }
        ...
        public void MostrarSiguientePaciente(Paciente siguientePaciente)
        {
            ...
            {
                listProximos.Items.Add("No hay pacientes en Pediatria");
            }
        }
    }
}
